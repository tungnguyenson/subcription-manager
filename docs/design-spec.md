...
## 4. Màn hình 1: Sắp tới

Màn hình chính, mở app là thấy.

### 4.1 Việc nó phải làm
...
### 4.6 Trạng thái cảnh báo bắt buộc
...
### 5.3 Mục Mức 1 không tự biến mất
...
### 6.2 Thay bằng: hiện nguồn gốc của mỗi con số
...
### 6.4 Gói giữ số là hành động chính cho SIM ngủ đông
...
### 7.5 Màn hình che và xác nhận gửi
...
### 8.3 Đã qua và sắp tới là hai thứ khác nhau
...
### 8.5 Mục không có tiền không được tính vào tổng
...
## 10. Ràng buộc kỹ thuật ảnh hưởng tới thiết kế
...
## 12. Câu hỏi để ngỏ cho người thiết kế
