...
///
/// The two symbol chips are not decoration: the same digits mean two things a
...
class CostField extends StatelessWidget {
  ...
  /// `VND` or `USD`. Decides the keyboard, the allowed characters and which of
  /// the two symbol chips is lit.
