...
abstract final class SubdockMarks {
  ...
  static const List<(String, MarkSpec)> _rules = [
    ...
    ('character.ai', GlyphSpec(CategoryGlyph.ai, brandColour: 0xFF111111)),
    ...
    ('kaspersky', GlyphSpec(CategoryGlyph.shield, brandColour: 0xFF006D5C)),
    ...
    ('o\'reilly', GlyphSpec(CategoryGlyph.education, brandColour: 0xFFD3002D)),
    ('substack', BrandSpec('substack')),
    ('telegram', BrandSpec('telegram-premium')),
    ('uber one', BrandSpec('uber-one')),
    ('ubisoft+', GlyphSpec(CategoryGlyph.gaming, brandColour: 0xFF0B0B0B)),
    ...
    ('kindle', GlyphSpec(CategoryGlyph.book, brandColour: 0xFFFF9900)),
    ('linear', BrandSpec('linear')),
    ('mcafee', BrandSpec('mcafee')),
    ('medium', BrandSpec('medium')),
    ('grindr', GlyphSpec(CategoryGlyph.dating, brandColour: 0xFFFFCC00)),
